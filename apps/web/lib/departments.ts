...
export const DEPARTMENTS: Department[] = [
  {
    ...
    color: '#3b82f6',
    courses: [
      { id: 'c-sta-201', code: 'STA 201', title: 'Probability I', color: '#3b82f6', level: '200L', documentCount: 6 },
      { id: 'c-sta-202', code: 'STA 202', title: 'Probability II', color: '#2563eb', level: '200L', documentCount: 5 },
      { id: 'c-sta-211', code: 'STA 211', title: 'Statistical Inference I', color: '#0284c7', level: '200L', documentCount: 4 },
      { id: 'c-sta-301', code: 'STA 301', title: 'Regression Analysis', color: '#0891b2', level: '300L', documentCount: 7 },
      { id: 'c-sta-302', code: 'STA 302', title: 'Time Series Analysis', color: '#0e7490', level: '300L', documentCount: 5 },
      { id: 'c-sta-303', code: 'STA 303', title: 'Design of Experiments', color: '#06b6d4', level: '300L', documentCount: 4 },
      { id: 'c-sta-304', code: 'STA 304', title: 'Sampling Techniques', color: '#22d3ee', level: '300L', documentCount: 6 },
      { id: 'c-sta-305', code: 'STA 305', title: 'Multivariate Analysis', color: '#67e8f9', level: '300L', documentCount: 4 },
      { id: 'c-sta-401', code: 'STA 401', title: 'Stochastic Processes', color: '#155e75', level: '400L', documentCount: 5 },
      { id: 'c-sta-402', code: 'STA 402', title: 'Nonparametric Statistics', color: '#164e63', level: '400L', documentCount: 3 },
      { id: 'c-sta-403', code: 'STA 403', title: 'Bayesian Statistics', color: '#083344', level: '400L', documentCount: 4 },
      { id: 'c-sta-404', code: 'STA 404', title: 'Statistical Computing', color: '#1d4ed8', level: '400L', documentCount: 6 },
    ],
  },
  {
    id: 'dept-physics',
