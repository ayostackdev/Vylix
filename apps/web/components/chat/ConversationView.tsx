      ...
      <div className={`max-w-[75%] ${isOwn ? 'order-1' : 'order-1'}`}>
        ...
        <div
          className={`relative rounded-2xl px-4 py-2.5 text-sm leading-relaxed ${
            isOwn
              ? 'bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-500 text-white'
          ...
          {isEditing ? (
            <div className="flex flex-col gap-2">
              <input
                ...
                className="w-full rounded-lg border border-blue-200 bg-white px-3 py-1.5 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-blue-400"
                autoFocus
                onKeyDown={(e) => {
      ...
      <div className="border-t border-blue-100 px-4 py-3">
        <div className="mx-auto max-w-3xl">
          ...
          <button
            ...
            className="rounded-xl bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-500 px-4 py-2.5 text-sm font-bold text-white shadow-md transition-all hover:shadow-lg disabled:opacity-40"
          >
