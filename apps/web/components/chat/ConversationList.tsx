      ...
      <div className="border-b border-blue-100 px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={onCreateNew}
              className="inline-flex items-center gap-1 rounded-lg bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-500 px-2 py-1.5 text-[10px] font-bold text-white shadow-md hover:shadow-lg transition-all"
            >
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center px-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-50 to-emerald-50 flex items-center justify-center mb-3 ring-1 ring-blue-100/50">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    {conv.type === 'GROUP' ? (
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-emerald-500 flex items-center justify-center text-white text-sm font-bold shrink-0 shadow-sm ring-2 ring-blue-100">
