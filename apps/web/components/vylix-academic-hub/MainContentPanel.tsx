            ...
            className={`inline-flex items-center gap-1.5 text-[11px] sm:text-xs px-2 sm:px-3 py-2 rounded-xl font-semibold min-h-[36px] sm:min-h-[38px] transition-all duration-200 ${
              isReadOnly
                ...
                : driveConnected
                  ...
                  : 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white hover:shadow-lg btn-glow'
            }`}
          >
            {isReadOnly ? (
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-5">
        {viewerUrl ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center px-4 premium-fade-in">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-indigo-50 to-violet-50 flex items-center justify-center mb-4 ring-1 ring-indigo-100/50">
              <svg className="w-10 h-10 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-sm font-bold text-gray-700 mb-1">Ready to read</h3>
            <p className="text-xs text-gray-400 max-w-xs">Click <strong className="text-indigo-500">View</strong> on a document to start reading, or chat with AI about it.</p>
          </div>
        ) : (
          <div>
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 sm:py-20 text-center px-4 premium-fade-in">
                <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-indigo-50 to-violet-50 flex items-center justify-center mb-5 ring-1 ring-indigo-100/50">
                  <svg className="w-10 h-10 text-indigo-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  {driveConnected ? (
                    <button
                      ...
                      className="inline-flex items-center gap-2 text-sm px-5 py-2.5 rounded-xl font-bold transition-all duration-200 bg-gradient-to-r from-indigo-600 to-violet-600 text-white btn-glow hover:shadow-lg hover:shadow-indigo-600/25 hover:scale-[1.02] active:scale-[0.98]"
                    >
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-2 text-sm px-5 py-2.5 rounded-xl font-bold transition-all duration-200 ${
                        isReadOnly
                          ...
                          : 'bg-gradient-to-r from-indigo-600 to-violet-600 text-white btn-glow hover:shadow-lg hover:shadow-indigo-600/25 hover:scale-[1.02] active:scale-[0.98]'
                      }`}
                    >
                      {isReadOnly ? (
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              ...
              <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 premium-stagger">
                    ...
                    <div className="p-3.5 sm:p-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="text-xs sm:text-sm font-semibold text-gray-900 truncate group-hover:text-indigo-700 transition-colors">{doc.file_name}</h3>
                          <div className="flex items-center gap-1.5 text-[10px] sm:text-xs text-gray-400 mt-1">
                            ...
                            {doc.is_seed && (
                              <>
                                <span className="w-0.5 h-0.5 rounded-full bg-gray-300" />
                                <span className="inline-flex items-center px-1.5 py-0.5 rounded-md text-[10px] font-semibold bg-indigo-50 text-indigo-600">
                                  Demo
                                </span>
                              </>
                            )}
                              ...
                              <>
                                ...
                                <span className="flex items-center gap-1 text-gray-500">
                                  {doc.uploader_avatar ? (
                                    ...
                                    <span className="w-3.5 h-3.5 rounded-full bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center text-white text-[8px] font-bold">
                      ...
                      <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-100/80">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-1.5 text-[10px] sm:text-xs font-semibold text-indigo-600 hover:text-white px-3 py-2 rounded-lg hover:bg-indigo-500 transition-all duration-200"
                        >
                          <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <label className={`doc-card group border-dashed !border-gray-200 hover:!border-indigo-300 ${isReadOnly ? 'pointer-events-none' : 'cursor-pointer'}`}>
                  <div className="p-3.5 sm:p-4 flex flex-col items-center justify-center min-h-[140px]">
                    <div className={`w-10 h-10 rounded-2xl flex items-center justify-center mb-2 transition-colors duration-200 ${isReadOnly ? 'bg-amber-50' : 'bg-gray-50 group-hover:bg-indigo-50'}`}>
                      {isReadOnly ? (
                    ...
                    <p className={`text-[11px] font-semibold transition-colors ${isReadOnly ? 'text-amber-400' : 'text-gray-400 group-hover:text-indigo-500'}`}>
                      {isReadOnly ? 'Sign in to Upload' : 'Upload PDF'}
                    </p>
                    {!isReadOnly && <input type="file" accept=".pdf" className="hidden" onChange={handleUpload} />}
                  </div>
