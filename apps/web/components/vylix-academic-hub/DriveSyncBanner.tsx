...
export function DriveSyncBanner() {
  ...
  return (
    <div className="mb-4 p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-indigo-50 to-violet-50 border border-indigo-100/60 ring-1 ring-indigo-200/30 premium-fade-in">
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-600 to-violet-600 flex items-center justify-center shrink-0 shadow-md shadow-indigo-600/20">
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-1.5 text-xs px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-white font-bold btn-glow hover:shadow-lg hover:shadow-indigo-600/25 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 min-h-[38px]"
        >
