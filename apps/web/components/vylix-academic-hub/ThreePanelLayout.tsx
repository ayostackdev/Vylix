...
export function ThreePanelLayout() {
  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden premium-bg">
      ...
      {/* Desktop sidebar */}
      <div className="hidden md:flex shrink-0 panel-glow-right">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-30 bottom-nav pb-[env(safe-area-inset-bottom)] md:hidden safe-bottom">
        <div className="flex items-center justify-around px-2 py-1.5">
          <button
            ...
            className={`bottom-nav-item flex flex-col items-center gap-0.5 px-4 py-1.5 rounded-xl relative ${mobileNav === 'courses' ? 'is-active' : 'text-gray-400'}`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className={`bottom-nav-item flex flex-col items-center gap-0.5 px-4 py-1.5 rounded-xl relative ${mobileNav === 'content' ? 'is-active' : 'text-gray-400'}`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className={`bottom-nav-item flex flex-col items-center gap-0.5 px-4 py-1.5 rounded-xl relative ${mobileNav === 'tools' ? 'is-active' : 'text-gray-400'}`}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
