      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 pt-[max(0.75rem,env(safe-area-inset-top))] divider-premium md:hidden shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-blue-500 to-emerald-500 flex items-center justify-center shadow-sm shadow-blue-500/20">
        ...
        {selectedDoc && (
          <div className="px-4 py-2.5 bg-gradient-to-r from-blue-50/80 to-emerald-50/40 border-b border-blue-100/50 shrink-0">
