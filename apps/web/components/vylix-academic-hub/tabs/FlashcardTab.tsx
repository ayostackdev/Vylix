    ...
    return (
      <div className="flex flex-col h-full bg-white items-center justify-center p-6 text-center">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-emerald-500 text-white text-xs font-bold shadow-md"
        >
          Sign In
        </button>
      </div>
      ...
      <div className="flex flex-col h-full bg-white">
        ...
        <div className="px-4 pt-3 shrink-0">
          <div className="h-1.5 bg-gray-100 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-blue-500 to-emerald-500 rounded-full transition-all duration-300" style={{ width: `${((currentIdx + 1) / cards.length) * 100}%` }} />
          </div>
        </div>
        ...
        {reviewDone ? (
          <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-emerald-500 text-white text-xs font-bold shadow-md"
            >
              Back to Decks
            </button>
          </div>
