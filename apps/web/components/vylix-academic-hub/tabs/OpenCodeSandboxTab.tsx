        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleRun}
              disabled={isRunning}
              className="text-xs py-2 px-4 min-h-[44px] rounded-lg bg-gradient-to-r from-blue-500 to-emerald-500 text-white hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] font-medium transition-all duration-200 disabled:opacity-50"
            >
