    ...
    return (
      <div className="flex flex-col h-full bg-white">
        ...
        <div className="flex-1 flex items-center justify-center p-6 text-center">
          <div>
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-50 to-emerald-50 flex items-center justify-center mx-auto mb-4 ring-1 ring-blue-100/50">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        {tasks.length === 0 && !studyPlan && (
          <div className="text-center py-8">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-50 to-emerald-50 flex items-center justify-center mx-auto mb-4 ring-1 ring-blue-100/50">
            ...
            <button
              ...
              className="mt-4 w-full py-3 rounded-xl bg-gradient-to-r from-blue-500 to-emerald-500 text-white font-medium text-sm hover:shadow-md transition-all disabled:opacity-50"
            >
              {agent.isPending ? (
