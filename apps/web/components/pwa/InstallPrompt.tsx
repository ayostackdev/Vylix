          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-500 text-white rounded-lg font-bold transition-colors hover:shadow-md"
              >
                Install
              </button>
              <button
                onClick={handleDismiss}
                className="px-4 py-2 bg-white text-transparent bg-gradient-to-r from-blue-600 via-sky-500 to-emerald-500 bg-clip-text rounded-lg font-bold hover:bg-blue-50 border border-blue-200 transition-colors"
              >
                Maybe later
              </button>
            </div>
