        ...
        <header className="sticky top-0 z-50 w-full border-b border-blue-100 bg-white/80 p-4 backdrop-blur">
          <div className="cp-fade-up flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 space-y-4">
              <div className="cp-pill inline-flex items-center gap-2 rounded-full border border-green-300 bg-green-100 px-3 py-1 text-gray-700 shadow-sm">
                Academic Hub
            ...
            <div className="flex flex-col gap-3 lg:items-end">
              <div className="flex flex-wrap items-center gap-2 text-sm text-gray-800 lg:justify-end">
                <span className="rounded-full border border-green-300 bg-green-100 px-3 py-1 text-[11px] font-semibold text-green-700 shadow-sm sm:text-xs">
                    ...
                    {!isAuthenticated ? (
                      <div className="mx-auto max-w-2xl rounded-[1.75rem] border border-green-200 bg-white px-6 py-12 text-center shadow-[0_16px_40px_rgba(59,130,246,0.08)]">
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-full border border-blue-100 bg-blue-50 px-6 py-3 font-semibold text-sky-700 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-blue-50 hover:shadow-md"
                        >
