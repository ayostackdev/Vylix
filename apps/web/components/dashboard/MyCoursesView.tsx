...
export function MyCoursesView({ onOpenProfile }: MyCoursesViewProps) {
  ...
  if (!isAuthenticated) {
    return (
      <div className="rounded-[1.75rem] border border-blue-100 bg-gradient-to-br from-blue-50 to-sky-50/35 p-6 text-center shadow-sm">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-blue-600 via-sky-600 to-cyan-400 px-5 py-2 text-sm font-bold text-white shadow-md transition-all hover:-translate-y-0.5 hover:shadow-lg"
        >
