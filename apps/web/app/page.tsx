      ...
      <div className="flex min-h-dvh items-center justify-center bg-gradient-to-br from-[#0B0E1A] via-[#101F3C] to-[#0E3A52]">
        <div className="text-center">
          <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/10 flex items-center justify-center mx-auto mb-4 shadow-2xl shadow-blue-600/10">
            <span className="text-3xl font-black text-white" style={{ WebkitTextFillColor: 'transparent', background: 'linear-gradient(135deg, #60a5fa, #22d3ee)', WebkitBackgroundClip: 'text', backgroundClip: 'text' }}>V</span>
          </div>
